...
The figures outputted include precision, recall and f1-score. The precision quantifies the number of predictions that belong to the class. The recall quantifies the number of class predictions made out of all examples in the dataset. The f1 score is a combination of both precision and f1-score. The closer to one these figures are the better the model is.
